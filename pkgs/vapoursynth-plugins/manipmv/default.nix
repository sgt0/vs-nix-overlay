...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-7ZGd8WgJbhJLLs8WyUY+wDnCJCEO7Ugggeh9uJCSb8Y=";
  };
  ...
  postInstall = ''
    ...
    ln -s $out/manipmv${stdenv.hostPlatform.extensions.sharedLibrary} $out/lib/vapoursynth/libmanipmv${stdenv.hostPlatform.extensions.sharedLibrary}
  '';
